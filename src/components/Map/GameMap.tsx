...
import { MapContainer, ImageOverlay, Marker, Popup, Tooltip, ZoomControl, useMapEvents } from 'react-leaflet';
  ...
  const map = useMapEvents({
    mousemove(e) {
      if (!isFocused) {
        ...
        setInputValue(`${Math.round(e.latlng.lng)}, ${Math.round(e.latlng.lat)}`);
      }
    },
    mouseout() {
      if (!isFocused) {
              ...
              {marker.type === 'exhibit' && marker.title && (
                <Popup>
                  <div className="max-w-xs">
                    <h3 className="font-bold font-serif text-lg mb-2">{marker.title}</h3>
                ...
                <Popup minWidth={500} maxWidth={800}>
                  <div className="max-w-sm">
                    ...
                    {marker.images && marker.images.length > 0 && (
                      <div className={`flex flex-col gap-2 ${marker.images.length > 1 ? 'max-h-80 overflow-y-auto' : ''}`}>
        ...
        >
          ...
          >
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-xl font-bold text-black">Solution Instructions</h2>
              <button 
            ...
            <div className="space-y-4 text-sm text-black">
              <div>
                ...
                <table className="w-full border-collapse">
                  <tbody>
                    <tr><td className="border px-2 py-1 font-mono">L</td><td className="border px-2 py-1">Move left</td></tr>
                    <tr><td className="border px-2 py-1 font-mono">R</td><td className="border px-2 py-1">Move right</td></tr>
                    <tr><td className="border px-2 py-1 font-mono">U</td><td className="border px-2 py-1">Move up</td></tr>
                    <tr><td className="border px-2 py-1 font-mono">D</td><td className="border px-2 py-1">Move down</td></tr>
                  </tbody>
                </table>
                <p className="mt-2 text-gray-600">Each dash indicates the manipulation of one specific item on an island.</p>
              </div>
              
              <div>
                <h3 className="font-bold mb-2">General Directions</h3>
                <p className="text-gray-600 mb-2">These rely on the UI coordinate display. A direction is completed once the referenced coordinates are displayed.</p>
                <table className="w-full border-collapse text-xs">
                  <tbody>
                    <tr><td className="border px-2 py-1 font-mono">N: x - y</td><td className="border px-2 py-1">Exit north to indicated coordinates</td></tr>
                    <tr><td className="border px-2 py-1 font-mono">W: x - y</td><td className="border px-2 py-1">Exit west to indicated coordinates</td></tr>
                    <tr><td className="border px-2 py-1 font-mono">S: x - y</td><td className="border px-2 py-1">Exit south to indicated coordinates</td></tr>
                    <tr><td className="border px-2 py-1 font-mono">E: x - y</td><td className="border px-2 py-1">Exit east to indicated coordinates</td></tr>
                    <tr><td className="border px-2 py-1 font-mono">R-N: x - y</td><td className="border px-2 py-1">Exit by raft heading north</td></tr>
                    <tr><td className="border px-2 py-1 font-mono">R-W: x - y</td><td className="border px-2 py-1">Exit by raft heading west</td></tr>
                    <tr><td className="border px-2 py-1 font-mono">R-S: x - y</td><td className="border px-2 py-1">Exit by raft heading south</td></tr>
                    <tr><td className="border px-2 py-1 font-mono">R-E: x - y</td><td className="border px-2 py-1">Exit by raft heading east</td></tr>
                    <tr><td className="border px-2 py-1 font-mono">M: x - y</td><td className="border px-2 py-1">Exit via mail to indicated coordinates</td></tr>
                    <tr><td className="border px-2 py-1 font-mono">C: x - y</td><td className="border px-2 py-1">Continue forward until you reach coordinates</td></tr>
                    <tr><td className="border px-2 py-1 font-mono">x - y:</td><td className="border px-2 py-1">Go to coordinates and continue there</td></tr>
                  </tbody>
                </table>
              </div>
            </div>
